...
public enum ChessPosition {
    ...
    public static ChessPosition get(int file, int rank) {
    ...
    public static ChessPosition get(ChessPosition pos1, int dFile, int dRank) {
        if (pos1 == null) {
            return null;
        }

        return get(pos1.getFile() + dFile, pos1.getRank() + dRank);
    }
}